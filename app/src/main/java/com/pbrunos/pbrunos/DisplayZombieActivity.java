...
public class DisplayZombieActivity extends Activity {
    ...
    private ArrayList<String> mmovieText1 = new ArrayList<>();
    private ArrayList<String> mmovieText2 = new ArrayList<>();
    private ArrayList<String> mmovieText3 = new ArrayList<>();
    private ArrayList<String> mmovieText4 = new ArrayList<>();
